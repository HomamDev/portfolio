...
const DESKTOP: PlacementData[] = [
  ...
  { id: "next",     cardWidth: 82, x: 90,  y: 35,   rotation: -3,   duration: 8.3, delay: 0.8 },
...
const TABLET: PlacementData[] = [
  ...
  { id: "next",     cardWidth: 56, x: 90,  y: 35,   rotation: -2.5, duration: 8.5, delay: 0.5 },
...
const MOBILE: PlacementData[] = [
  ...
  { id: "next",     cardWidth: 42, x: 90,  y: 40,   rotation: -5,   duration: 8.0, delay: 1.8 },
